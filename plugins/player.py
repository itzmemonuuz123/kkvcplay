...
async def play(_, message: Message):
    ...
    lel = await message.reply("**search ചെയ്യട്ടെ...**")
    ...
    if audio:
        if round(audio.duration / 60) > DURATION_LIMIT:
            raise DurationLimitError(
                f"**ആഹ് . കിട്ടി ..playing via @Stenzle_MariaGbot.any query contact - പള്ളിയിൽ പോയി പറ**"
            )

        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/a3ee423130bd1b1093fe1.jpg"
...
async def stop(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/a3ee423130bd1b1093fe1.png", 
                             caption="**💥 Ʌɗɩtyɑ 🔈 Mʋsɩƈ🤞Nøω 🥀\n❌ Sʈøƥƥɘɗ 🌷 ...**"
    )
...
async def admincache(client, message: Message):
    ...
    await message.reply_photo(
                              photo="https://telegra.ph/file/a3ee423130bd1b1093fe1.jpg",
                              caption="**💥 Ʌɗɩtyɑ 🔈 Mʋsɩƈ🤞Nøω 🥀\n🔥 Ʀɘɭøɑɗɘɗ 🌷 ...**"
    )
